package com.rdani2005.yawa.consumer.config;

import com.rdani2005.yawa.kafka.config.data.KafkaConfigData;
import com.rdani2005.yawa.kafka.config.data.KafkaConsumerConfigData;
...
/**
 * Configuration class for setting up the Kafka consumer using Spring Kafka.
 * This class defines the consumer properties and factory for creating Kafka message listeners.
 *
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    /**
     * Constructor to initialize Kafka configuration data and Kafka consumer configuration data.
     *
     * @param kafkaConfigData         Configuration properties for Kafka.
     * @param kafkaConsumerConfigData Configuration properties for the Kafka consumer.
     */
    ...
    /**
     * Defines the configuration properties for the Kafka consumer.
     *
    ...
    /**
     * Creates a Kafka ConsumerFactory using the configuration properties defined in consumerConfigs.
     *
    ...
    /**
     * Configures a KafkaListenerContainerFactory for creating Kafka message listener containers.
     *
